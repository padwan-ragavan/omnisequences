...
exports.main = function() {
    ...
    tabs.on('ready', function(tab) {
        ...
        var activeTabWorker = tab.attach({
                    contentScriptFile:[data.url('scripts/jquery-1.6.2.min.js'),resourceManager.getFunctionDataResource(),data.url('scripts/stringKeyExtractor.js'),data.url("scripts/sequenceBinder.js")]
                });
