...
var checkForUpgrade = function() {
    ...
    var newRules = [defaultRuleSet];
    if (existingRules != null) {
        for (var i in existingRules) {
            if (existingRules[i].name != defaultRuleSet.name) {
...
//    console.log("==================== starting to write" + (file.open("./build2.xml","w")));
//    var writer = file.open("newScript.js","w");
//
//    writer.write(defaultFunctionData);
//    writer.flush();
//    writer.close();
