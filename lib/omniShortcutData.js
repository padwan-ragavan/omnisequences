...
var webmailRuleSet = {
    ...
    shortcuts:[
            {key1:'u',key2:'',matchers:'',shortcutFunction:'goOneLevelUp', cache: true},
            {key1:'g',key2:'i',matchers:'',shortcutFunction:'goToHomePage', cache: true},
            {key1:'i',key2:'j',matchers:'',shortcutFunction:'attachJQuery', cache: true},
            {key1:'g',key2:'s',matchers:'a[title="Sent Items"]',shortcutFunction:'clickIfInsideSameSite', cache: true},
            {key1:'g',key2:'d',matchers:'a[title="Drafts"]',shortcutFunction:'clickIfInsideSameSite', cache: true},
            ...
            {key1:'j',key2:'',matchers:'.cntnt > table > tbody > tr:gt(1):visible,#lnkHdrnext',shortcutFunction:'moveToNextWebMail', cache: true},
            {key1:'k',key2:'',matchers:'.cntnt > table > tbody > tr:gt(1):visible,#lnkHdrprevious',shortcutFunction:'moveToPrevWebMail', cache: true},
            {key1:'c',key2:'',matchers:'#lnkHdrnewmsg',shortcutFunction:'clickIfInsideSameSite', cache: true},
            {key1:'o',key2:'',matchers:'.omniSequenceInFocus a',shortcutFunction:'clickIfInsideSameSite', cache: true},
    ...
    applyTo: ['file:///C:/Users/govindr*','https://webmail*'],
    dontApplyTo: []
};
